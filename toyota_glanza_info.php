...
<head>
    <meta charset="UTF-8">
    <title>Toyota Glanza - Car Information</title>
...
<div class="box">
    ...
    <p>
        The <strong>Toyota Glanza</strong> is a premium hatchback known for its stylish design,
        excellent fuel efficiency, smooth performance, and Toyota’s reliability.
        It is a perfect choice for city commuting and daily use.
    </p>

    <h2>Specifications</h2>
    <table>
        <tr><th>Feature</th><th>Details</th></tr>
        <tr><td>Engine</td><td>1.2L Petrol</td></tr>
        <tr><td>Fuel Type</td><td>Petrol / CNG</td></tr>
        <tr><td>Transmission</td><td>5-Speed Manual / AMT Automatic</td></tr>
        <tr><td>Power</td><td>90 PS (Petrol)</td></tr>
        <tr><td>Torque</td><td>113 Nm</td></tr>
        <tr><td>Seating Capacity</td><td>5 seats</td></tr>
        <tr><td>Boot Space</td><td>318 L</td></tr>
    ...
    <p>
        <strong>New:</strong> ₹6.9 Lakh – ₹10 Lakh (ex-showroom, India) <br>
