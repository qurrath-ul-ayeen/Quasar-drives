...
<head>
    <meta charset="UTF-8">
    <title>Audi A6 ‑ Car Information</title>
...
<div class="box">
    ...
    <p>
        The <strong>Audi A6</strong> is a premium executive sedan that blends performance,
        technology, comfort, and style. It delivers refined driving dynamics, advanced
        features, and a sophisticated interior experience.
    </p>

    <h2>Specifications</h2>
    <table>
        <tr><th>Feature</th><th>Details</th></tr>
        <tr><td>Engine</td><td>2.0L Turbocharged Petrol / 3.0L V6</td></tr>
        <tr><td>Fuel Type</td><td>Petrol / Mild Hybrid</td></tr>
        <tr><td>Transmission</td><td>7‑Speed S‑Tronic / 8‑Speed Tiptronic</td></tr>
        <tr><td>Power</td><td>245 PS – 335 PS (varies by engine)</td></tr>
        <tr><td>Torque</td><td>370 – 500 Nm</td></tr>
    ...
    <ul>
        ...
        <li>Audi Virtual Cockpit digital driver display</li>
