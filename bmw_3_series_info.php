...
<head>
    <meta charset="UTF-8">
    <title>BMW 3 Series ‑ Car Information</title>
...
<div class="box">
    ...
    <p>
        The <strong>BMW 3 Series</strong> is a premium executive sedan known for sporty handling,
        advanced technology, and luxurious comfort. It delivers a dynamic driving experience
        while maintaining elegance and style.
    </p>

    <h2>Specifications</h2>
    <table>
        <tr><th>Feature</th><th>Details</th></tr>
        <tr><td>Engine</td><td>2.0L Turbocharged Petrol / Diesel / Mild Hybrid</td></tr>
        <tr><td>Fuel Type</td><td>Petrol / Diesel / Hybrid</td></tr>
        <tr><td>Transmission</td><td>8‑Speed Automatic / 7‑Speed Dual Clutch</td></tr>
        <tr><td>Power</td><td>184 PS – 255 PS</td></tr>
        <tr><td>Torque</td><td>300 – 400 Nm</td></tr>
        <tr><td>Seating Capacity</td><td>5 seats</td></tr>
        <tr><td>Boot Space</td><td>480 L</td></tr>
        <tr><td>Drive Type</td><td>Rear-Wheel Drive / xDrive AWD</td></tr>
        <tr><td>Ground Clearance</td><td>140 mm approx.</td></tr>
    </table>
    ...
    <p>
        <strong>New:</strong> ₹45 Lakh – ₹60 Lakh (ex‑showroom, India) <br>
