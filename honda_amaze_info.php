...
<head>
    <meta charset="UTF-8">
    <title>Honda Amaze - Car Information</title>
...
<div class="box">
    ...
    <p>
        The <strong>Honda Amaze</strong> is a compact sedan known for its reliability,
        spacious cabin, smooth engine, and excellent fuel efficiency.
        It is a popular choice for small families and daily city driving.
    </p>
    ...
    <table>
        ...
        <tr><td>Transmission</td><td>5-Speed Manual / CVT Automatic</td></tr>
        <tr><td>Power</td><td>90 PS</td></tr>
        <tr><td>Torque</td><td>110 Nm</td></tr>
        <tr><td>Seating Capacity</td><td>5 seats</td></tr>
        <tr><td>Boot Space</td><td>420 L</td></tr>
        <tr><td>Fuel Tank Capacity</td><td>35 L</td></tr>
    ...
    <ul>
        ...
        <li>Spacious rear seat comfort</li>
    </ul>

    <h2>Safety Features</h2>
    <ul>
        <li>Dual front airbags (standard)</li>
        <li>ABS with EBD</li>
    ...
    <p>
        <strong>New:</strong> ₹7.5 Lakh – ₹9.8 Lakh (ex-showroom, India) <br>
