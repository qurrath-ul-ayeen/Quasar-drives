...
<head>
    <meta charset="UTF-8">
    <title>Honda Jazz - Car Information</title>
...
<div class="box">
    ...
    <p>
        The <strong>Honda Jazz</strong> is a premium hatchback known for its spacious interior,
        smooth engine performance, and excellent ride comfort.
        It is a great choice for city driving as well as highway trips.
    </p>
    ...
    <table>
        ...
        <tr><td>Boot Space</td><td>354 L</td></tr>
    ...
    <ul>
        ...
        <li>Premium interior quality</li>
        <li>Automatic climate control</li>
        <li>Cruise control</li>
        <li>Steering-mounted audio controls</li>
        <li>Spacious rear seat with magic seats</li>
    </ul>
    ...
    <p>
        <strong>New:</strong> ₹8.5 Lakh – ₹10.5 Lakh (when available) <br>
